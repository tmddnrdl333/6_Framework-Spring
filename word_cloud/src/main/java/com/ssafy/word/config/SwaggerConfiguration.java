...
//	http://localhost:8080/{your-app-root}/swagger-ui/index.html
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes())
				...
				.apis(RequestHandlerSelectors.basePackage("com.ssafy.word.controller")).paths(regex("/.*"))
...
//      consumes.add("application/xml;charset=UTF-8");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title).description(
				"<h3>SSAFY API Reference for Developers</h3>Swagger를 이용한 관심사 &amp; 차트 API<br><img src=\"/img/ssafy_logo.png\" width=\"150\">")
