...
public class LoggingAspect {
	...
	@AfterReturning(value = "execution(* com.ssafy.guestbook.model..GuestBook*.write*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.guestbook.model..GuestBook*.write*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.guestbook.model..GuestBook*.write*(..))")
